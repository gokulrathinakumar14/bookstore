...
<div class="bg-gray-200 h-screen flex justify-center items-center">
    <div class="bg-white w-[500px] p-8 rounded">
        <h4 class="text-lg text-center font-bold text-slate-500 my-3">Edit Book</h4>
        ...
        <form class="w-full max-w-md" action="/book" method="POST">
            ...
            <div class="md:flex md:items-center mb-6 w-full">
              ...
              <div class="md:w-2/3">
                <input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="book_title" name="book_title" type="text" placeholder="Book title" value="{{$book->book_title}}">
              </div>
            </div>
            {{-- Author Name --}}
            <div class="md:flex md:items-center mb-6">
              ...
              <div class="md:w-2/3">
                <input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="author_name" type="text" name="author_name" placeholder="Author Name" value="{{$book->author->author_name}}">
              </div>
            </div>
                ...
                <div class="md:w-2/3">
                  <select class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="price_range" name="price_range">
                    @foreach($price_ranges as $price_range)
                        <option value="{{$price_range->id}}" {{$price_range->id == $book->price->id ? "selected" : '' }}>{{$price_range->price_range}}</option>
                    @endforeach
                  </select>
                </div>
            </div>
            ...
            <div class="md:flex md:items-center mb-6 w-full">
                ...
                <div class="md:w-2/3">
                  <input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="isbn" name="isbn" type="text" placeholder="ISBN" value="{{$book->isbn}}">
                </div>
            </div>
            ...
            <div id="format_container">
                ...
                <div class="flex flex-wrap -mx-3 mb-2">
                        ...
                        <div class="relative">
                          <select class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" name="format_type[]">
                            @foreach($format_types as $format_type)
                                <option value="{{$format_type->id}}" {{ $inventory->format_id == $format_type->id ? "selected" : "" }}>{{$format_type->name}}</option>
                            @endforeach
                          </select>
                        </div>
                    </div>
                    ...
                    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                      ...
                      <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="text" placeholder="Number of Copies" name="num_of_copies[]" value="{{$inventory->num_of_copies}}">
                    </div>
                    ...
                    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                      ...
                      <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="text" placeholder="Price" name="prices[]" value="{{$inventory->price_id}}">
                    </div>
                </div>
                @endforeach
            </div>
